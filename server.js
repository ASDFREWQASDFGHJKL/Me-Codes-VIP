...
setInterval(() => {
  http.get(`http://me-vip.glitch.me/`);
}, 280000);
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : Me Codes`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : Me Codes ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`#help-vip-me | Me Codes V5.0.1`,"http://twitch.tv/Me Codes")
